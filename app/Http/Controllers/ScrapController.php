...
//        $description_ar = $tr->translate($description_en);
        ...
        $description_ar = str_replace('< br >', '', $description_ar);
        $description_ar = str_replace('<br >', '', $description_ar);
        $description_en = "<p>Welcome dear follower of the (journey for learn) website, we offer courses with coupons available for the first 1000 free registration only and other coupons for a limited time. We explain the short and long description of the courses in order to know the lessons that you will learn easily and easily:</p>" . $description_en . "<p>What are the basic requirements to enter the course and register for it on our website? Learning Journey:</p><p>(Get the course to enter the site and register)</p><p>You must have an email (mail account) that you remember for yourself and also you must remember the password of the email that you will register with, and if you do not have an email account, it is better to create an account (Gmail)</p>";
        $description_ar = "<p>أهلا بك عزيزي المتابع لموقع (journey for learn) نقدم دورات بكوبونات متاحة لاول 1000 تسجيل مجاني فقط وكوبونات اخري لفترة محدودة فاذا كنت تريد ان تحصل علي كل الكورسات علي موقعنا وان تكون اول المسجلين في الكورسات المجانية قم بتسجيل الدخول أوقم بالدخول علي وسائل التواصل الاجتماعي وخصوصا التليجرام نوضح الوصف المختصر والطويل  للدورات لكي تعرف الدروس التي سوف تتعلمها بسهولة ويسر :</p>" . $description_ar . "<p>ما هي المتطلبات الأساسية لدخول الدورة والتسجيل فيها على موقعنا؟ رحلة التعلم:</p><p>(احصل على الدورة للدخول إلى الموقع والتسجيل)</p><p>يجب أن يكون لديك بريد إلكتروني (حساب بريد) تتذكره لنفسك وأيضًا يجب أن تتذكر كلمة مرور البريد الإلكتروني الذي ستسجل به ، وإذا لم يكن لديك حساب بريد إلكتروني ، فمن الأفضل إنشاء حساب (Gmail)</p>";
    ...
    public function eduonix(Request $request)
    {
        ...
        $description_ar = str_replace('< br >', '', $description_ar);
        $description_ar = str_replace('<br >', '', $description_ar);
        $description_en = "<p>Welcome, dear follower of the journey for learn website, we offer free courses. If you want to get all the courses on our site and be the first to register for the free courses, log in or log in to social media, especially Telegram. We explain the short and long description of the courses so that you know the lessons that You will learn it easily and easily:</p>" . $description_en . "<p>What are the basic requirements to enter the course and register for it on our website? Learning Journey:</p><p>(Get the course to enter the site and register)</p><p>You must have an email (mail account) that you remember for yourself and also you must remember the password of the email that you will register with, and if you do not have an email account, it is better to create an account (Gmail)</p>";
        $description_ar = "<p>أهلا بك عزيزي المتابع لموقع (journey for learn) نقدم دورات مجانيه فاذا كنت تريد ان تحصل علي كل الكورسات علي موقعنا وان تكون اول المسجلين في الكورسات المجانية قم بتسجيل الدخول أوقم بالدخول علي وسائل التواصل الاجتماعي وخصوصا التليجرام نوضح الوصف المختصر والطويل للدورات لكي تعرف الدروس التي سوف تتعلمها بسهولة ويسر :</p>" . $description_ar . "<p>ما هي المتطلبات الأساسية لدخول الدورة والتسجيل فيها على موقعنا؟ رحلة التعلم:</p><p>(احصل على الدورة للدخول إلى الموقع والتسجيل)</p><p>يجب أن يكون لديك بريد إلكتروني (حساب بريد) تتذكره لنفسك وأيضًا يجب أن تتذكر كلمة مرور البريد الإلكتروني الذي ستسجل به ، وإذا لم يكن لديك حساب بريد إلكتروني ، فمن الأفضل إنشاء حساب (Gmail)</p>";
