...
//        $description_ar = $tr->translate($description_en);
    ...
    public function eduonix(Request $request)
    {
        ...
        $description_ar = "<p>أهلا بك عزيزي المتابع لموقع (Journey of Learn) نقدم دورات مجانيه فاذا كنت تريد ان تحصل علي كل الكورسات علي موقعنا وان تكون اول المسجلين في الكورسات المجانية قم بتسجيل الدخول أوقم بالدخول علي وسائل التواصل الاجتماعي وخصوصا التليجرام نوضح الوصف المختصر والطويل للدورات لكي تعرف الدروس التي سوف تتعلمها بسهولة ويسر :</p>" . $description_ar . "<p>ما هي المتطلبات الأساسية لدخول الدورة والتسجيل فيها على موقعنا؟ رحلة تعليمية:</p><p>أضغط على الزر الأخضر (احصل على الدورة للدخول إلى الموقع والتسجيل)</p><p>يجب أن يكون لديك بريد إلكتروني (حساب بريد) تتذكره لنفسك وأيضًا يجب أن تتذكر كلمة مرور البريد الإلكتروني الذي ستسجل به ، وإذا لم يكن لديك حساب بريد إلكتروني ، فمن الأفضل إنشاء حساب (Gmail)</p>";
